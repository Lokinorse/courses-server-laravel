...
class ProgramController extends VoyagerBaseController
{
        ...
        try {
            if ($program_id) {
                ...
                if ($program) {
                    ...
                    $relation->program_id = $program->id;
                    $relation->course_id = $course->id;
                    $relation->order = 0;
                    $relation->save();
                }
            }
    ...
    public function get_program_contents(Request $request)
    {
        ...
        return $program->renderChildren(null);
    }

    public function reorder_courses(Request $request)
    {
        $program = Program::where("id", $request->program_id)->first();
