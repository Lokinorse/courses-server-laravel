...
__webpack_require__(/*! ../community/message-actions */ "./resources/js/community/message-actions.js");
...
/***/ "./resources/js/community/message-actions.js":
/*!***************************************************!*\
  !*** ./resources/js/community/message-actions.js ***!
  \***************************************************/
/*! no static exports found */
...
function createEditor(messageId) {
  tinymce.init({
    ...
    toolbar: "bold italic | bullist numlist outdent indent | link image | codesample",
    convert_urls: false,
    image_caption: true,
    image_title: true,
...
function startSave(button, editor, messageId) {
  ...
  $.ajax({
    ...
    data: {
      content: content,
      title: getCurrentTitle(messageId)
    },
...
/***/ "./resources/js/components/prism.js":
/*!******************************************!*\
  !*** ./resources/js/components/prism.js ***!
  \******************************************/
/*! no static exports found */
...
function renderAnswers(question_id) {
  ...
  return answers.reduce(function (acc, answer) {
    ...
    return acc + "\n            <p>\n                <input type=\"radio\" id=\"ans".concat(answer.id, "\" class=\"answer-radio\" ").concat(isChecked, " name=\"answer\" value=\"").concat(answer.id, "\"/>\n                <label for=\"ans").concat(answer.id, "\">").concat(answer.name, "</label>\n            </p>\n        ");
  }, "");
}
...
module.exports = __webpack_require__(/*! C:\laragon\www\courses\resources\js\app\app.js */"./resources/js/app/app.js");
